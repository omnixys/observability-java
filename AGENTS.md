...
> Repository development instructions for **observability** (Shared Package).
> Stack: java-maven. Generated as part of the Omnixys repository-policy rollout.

## Repository Overview

Omnixys Observability Core Package — tracing, metrics, OpenTelemetry integration.

- Repository path: `packages/java/observability` (relative to the Omnixys root)
...
src/main/java/com/omnixys/observability/{tracing, metrics, autoconfigure}
